# Automated Story Pipeline — Technical Documentation
...
│  StoryPipeline system prompt    │        │  Image gen + Word doc    │
...
```
1. Build StoryPipeline system prompt (~4,000 tokens)
...
4. Save to documents/
   └─ StoryPipeline_{age}yr_{name}_{title}.docx
```
...
|------|----------|-----------|
| Word document | `./documents/StoryPipeline_...docx` | ✅ Unique per story |
| Markdown story | `./stories/StoryPipeline_STORY_...md` | ✅ Unique per story |
